 ...
 *
 * @param <COMPONENT> the type of the output component
 * @param <SOURCE>    the type of the input model object
 */
public class EnhancedHierarchyColumnComponentRenderer<COMPONENT extends Component, SOURCE>
	...
	public EnhancedHierarchyColumnComponentRenderer(ValueProvider<SOURCE, COMPONENT> componentProvider,
			EnhancedTreeGrid<SOURCE> grid) {
		...
		withProperty("children", item -> grid.getDataCommunicator().hasChildren(item));
	}
